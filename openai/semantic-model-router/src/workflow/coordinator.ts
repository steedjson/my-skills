...
export async function runWorkflow(
  ...
  return decision.route === "L"
    ? runLRoute(envelope, decision.reasonCodes, decision.summary, runner, signal)
    : runSRoute(envelope, decision.reasonCodes, decision.summary, runner, signal);
}
...
async function plan(prompt: string, runner: TurnRunner, signal?: AbortSignal): Promise<TaskPacket> {
...
function executorTarget(permissionMode?: string): RoleTarget {
...
function sReceipt(reasonCodes: string[], reason: string, prompt?: string): string {
